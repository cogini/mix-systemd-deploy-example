...
The script `bin/deploy-runtime-environment-file` generates
`/run/mix-systemd-deploy/runtime-environment` the same way as the wrapper
script, but persists the data.
